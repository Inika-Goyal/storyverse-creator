...
import { ArrowLeft, TrendingUp, Users, BookOpen, Eye, BarChart3 } from "lucide-react";
import { creatorStats, trendingTopics, nicheTopics, shows } from "@/data/mockData";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-24 px-4 md:px-12 pb-20">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-semibold">Creator Dashboard</h1>
            <p className="text-muted-foreground">Track your stories and audience insights</p>
          </div>
        </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Your Niche</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="mt-8">
          ...
          <div className="flex flex-wrap gap-3">
            {nicheTopics[creatorStats.primaryNiche]?.map((topic) => (
              <span
                key={topic}
                className="px-4 py-2 bg-primary/20 text-primary hover:bg-primary/30 rounded-full cursor-pointer transition-colors"
              >
                {topic}
              </span>
            ))}
